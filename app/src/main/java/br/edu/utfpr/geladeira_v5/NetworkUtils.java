...
public class NetworkUtils {
    ...
    final static String APP_ALIMENTOS = "https://webgelateljava.herokuapp.com/appalimentos";
    ...
    public static URL appalimentos(String username, String password) {
        // COMPLETED (1) Fill in this method to build the proper GitHub query URL
        Uri builtUri = Uri.parse(APP_ALIMENTOS).buildUpon()
                .appendQueryParameter(PARAM_USERNAME, username)
                .appendQueryParameter(PARAM_PASSWORD, password)
                .build();
